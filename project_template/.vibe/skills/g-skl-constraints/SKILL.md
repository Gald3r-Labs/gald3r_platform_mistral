...
**Owner**: File-centric owner of `.gald3r/CONSTRAINTS.md`
...
CONSTRAINT CHECK:
  ...
  C-009 [12-target propagation] (local-only): ⚠️ POSSIBLE — skill added to gald3r_template_full; confirm root copies exist
