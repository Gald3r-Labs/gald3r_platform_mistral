...
- Does NOT trigger the CONFLICT gate in g-skl-wpac-order
...
```
@g-wpac-notify --parent "Completed T024 subsystem rename — all subsystem names updated"
@g-wpac-notify --all-siblings "New g-skl-learn skill available via template propagation"
@g-wpac-notify --project /path/to/sibling "Bug found in shared API contract (non-blocking, will fix T036)"
@g-wpac-notify --all-siblings --capability-update "vault-ingestion: planned → ready (T116 complete)"
```
